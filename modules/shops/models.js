...
const shopDetailsSchema = new Schema(shopDetails, { versionKey: false, timestamps: true });

// Shop Address
const shopAddress = {
    _id: { type: objectId, auto: true },
    shopId: { type: objectId, required: true },
    primaryAddressOne: {type: String, required: [true, "Primary address line is required"]},
...
const shopAddressSchema = new Schema(shopAddress, { versionKey: false, timestamps: true });
...
const shopAccount = {
    ...
    accountBranch: {type: String, required: [true, "Account branch is required"]},
...
const shopAccountSchema = new Schema(shopAccount, { versionKey: false, timestamps: true });
...
const subscriptionsSchema = new Schema(subscriptions, { versionKey: false, timestamps: true });
